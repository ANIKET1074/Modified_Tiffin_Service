                ...
                <div class="card bg-[white] shadow-xl p-2 rounded-[1.1rem] border w-[25rem] h-[25rem]">
                    ...
                    <div class="p-4 flex flex-col gap-[0.7rem]">
                        ...
                        <div class="flex items-center justify-between ">
                            ...
                            <button onclick="document.getElementById('id<?php echo $row['foodid'] ?>').style.display='block'" class="w-[10rem] mt-[1rem] m-auto p-3 rounded">Order
                                Now</button>
                                ...
                                <form class="modal-content animate flex-[1] mt-[5rem] mx-auto w-[80rem] h-[35rem] flex rounded-[1.2rem]" action="./profile/manage_cart.php" method="post">
                                    ...
                                    <div class="imgcontainer flex-[1] flex flex-col items-center mt-[5rem] gap-[2rem]">
                                        ...
                                        <div class="bg-[white] shadow-xl border rounded w-[25rem] mt-[4rem] p-2 flex justify-center items-center">
                                            <img src="../images/food/<?php echo $row['image_upload'] ?>" alt="Avatar" class="avatar w-[25rem] h-[15rem]">
                                        </div>
                                    ...
                                    <div class="flex flex-col flex-[1]">
                                        ...
                                        <div class="container mt-[2rem] flex flex-col gap-[1.2rem]">
                                            ...
                                            <div class="flex items-center gap-[1rem]">
                                                ...
                                                <input type="text" id="" class="rounded-[0.5rem]" placeholder="" value="<?php echo $row['food_name'] ?>" name="foodname" hidden>
                                            </div>
                                            <input type="number" id="" class="rounded-[0.5rem]" placeholder="" value=<?php echo $row['foodid'] ?> name="foodid" hidden>
                                            <input type="number" id="" class="rounded-[0.5rem]" placeholder="" value=<?php echo $kid ?> name="kitchenid" hidden>

                                            <div class="flex items-center gap-[1rem]">

                                                <label class="w-[8rem] p-1"><b>Price : <?php echo $row['price'] ?>₹</b></label>
                                                <input type="number" id="amt<?php echo $index ?>" class="amt rounded-[0.5rem]" placeholder="" value=<?php echo $row['price'] ?> name="amount" hidden>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-[1rem]">
                                                ...
                                                <input type="number" id="qty<?php echo $index ?>" class="qty rounded-[0.5rem]" placeholder="Enter Quantity" name="quantity">
                                            </div>

                                            <div class="flex items-center gap-[1rem]">

                                                <label class="w-[8rem] p-1"><b>Total Amount</b></label>
                                                <input type="number" id="total_amt<?php echo $index ?>" class="total_amt rounded-[0.5rem]" placeholder="Enter Password" name="total_amt" disabled>
                                            </div>
